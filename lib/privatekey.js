...
PrivateKey._transformBuffer = function(buf, network) {
  ...
  info.network = Networks.get(buf[0], 'privatekey') || Networks.get(buf[0], 'privatekeyOld');
 ...
 * @returns {string} A WIP representation of the private key
 */
PrivateKey.prototype.toBech32 = function(network) {
  var pubkey = this.toPublicKey();
  return Address.toBech32(pubkey, network || 'livenet');
};
